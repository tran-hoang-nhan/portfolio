  ...
  const tracks = [
    {
      ...
      description: 'Studying Information Technology at Vietnam Aviation Academy (VAA). Building a strong foundation in software engineering principles since 10/2023.',
      skills: ['CS Degree', 'Algorithms', 'Data Structures', 'OOP'],
      color: 'from-red-500 to-orange-500',
    },
    {
      icon: <Palette size={32} />, 
      title: 'Track 02: Tech Stack & Expertise',
      subtitle: 'Mobile, Web & Intelligence',
      description: 'A versatile developer with a passion for cross-platform mobile apps using Flutter and dynamic web interfaces with ReactJS. Currently expanding into Machine Learning and Computer Vision with Python.',
      skills: ['Flutter/Dart', 'ReactJS/Vite', 'JavaScript/Node.js', 'Python/CV', 'Supabase', 'PHP/Laravel'],
    ...
    {
      icon: <Zap size={32} />,
      title: 'Track 04: Future Vision',
      subtitle: 'Bridging App Dev & AI',
      description: 'My goal is to not just build apps, but smart solutions. I aim to integrate AI/ML models into mobile and web experiences, creating interactive 3D environments and intelligent user assistants.',
      skills: ['AI Integration', '3D Web (Three/Spline)', 'Mobile First', 'Continuous Learning'],
